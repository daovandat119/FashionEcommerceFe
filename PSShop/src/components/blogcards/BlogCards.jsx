...
export default function BlogCards() {
  ...
  //             >
  //               <img className="h-[100%] w-[100%] object-cover" src="https://cdn2.fptshop.com.vn/unsafe/Uploads/images/tin-tuc/177066/Originals/poster-bong-da-1.jpg"/>
  //             </div>
  ...
  //             >
  //               <img className="h-[100%] w-[100%] object-cover" src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/soccer-banner-template-design-a2b17ea0fb24a1d7a5e7a7a3afec4dbd_screen.jpg?ts=1622168275"/>
  //             </div>
              
  //           </div>
  //           <div className="flex w-[50%] justify-center mx-auto gap-3 ">
           
  //           <img className=" relative w-[98%]  object-cover" src="https://cdn.luongsport.com/wp-content/uploads/2020/10/vot-cau-long-lining-banner.jpg"/>
           
  //           <img className=" w-[98%]  object-cover" src="https://assets.bwbx.io/images/users/iqjWHBFdfxIU/ilMGpe.nT9oc/v3/-1x-1.png"/>
