...
import { GetProductStatistics, GetProductVariantsStatistics } from '../service/api_service';
                ...
                <table className="min-w-full border border-gray-300">
                    <thead>
                        <tr className="bg-gray-100">
                            ...
                            <th className="border border-gray-300 p-2">Số lượng trong kho</th>
                        ...
                        {filteredProducts.slice(0, itemsPerPage).map((product, index) => (
                            <React.Fragment key={index}>
                                <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="border border-gray-300 p-2">{product.totalSold}</td>
                                    <td className="border border-gray-300 p-2">{product.total.toLocaleString()} VNĐ</td>
                                        ...
                                        <td colSpan="5" className="border border-gray-300 p-2">
                                            <div>
                                                ...
                                                <table className="min-w-full border border-gray-300">
                                                    <thead>
                                                        <tr className="bg-gray-100">
                                                            <th className="border border-gray-300 p-2">Kích thước</th>
                                                    ...
                                                    <tbody>
                                                        {productVariants.map((variant, index) => (
                                                            <tr key={index} className="hover:bg-gray-50">
                                                                ...
                                                                <td className="border border-gray-300 p-2">{variant.TotalSold}</td>
                                                                <td className="border border-gray-300 p-2">{parseFloat(variant.Price).toLocaleString()} VNĐ</td>
                                                                <td className="border border-gray-300 p-2">{parseFloat(variant.TotalRevenue).toLocaleString()} VNĐ</td>
                                                            </tr>
                                                        ))}
                                                    </tbody>
                                                </table>
